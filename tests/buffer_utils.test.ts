...
Deno.test("uint16sToBytes(*)", () => {
  assertStrictEquals(uint16sToBytes(Uint16Array.of()).length, 0);

  const a1be = uint16sToBytes(
  ...
  const a1x = uint16sToBytes(Uint16Array.of(0, 1, 65535));
  assertStrictEquals(a1x.length, 6);
  if (isBigEndian()) {
    assertStrictEquals(a1x[0], 0);
    assertStrictEquals(a1x[1], 0);
...
Deno.test("uint16sToBytes(*)", () => {
  ...
  assertStrictEquals(uint16sToBytes(g0).length, 0);
  ...
  const a1be = uint16sToBytes(g1, ByteOrder.BIG_ENDIAN);
  assertStrictEquals(a1be.length, 6);
  assertStrictEquals(a1be[0], 0);
  assertStrictEquals(a1be[1], 0);
  assertStrictEquals(a1be[2], 0);
  ...
  const a1le = uint16sToBytes(g2, ByteOrder.LITTLE_ENDIAN);
  assertStrictEquals(a1le.length, 6);
  assertStrictEquals(a1le[0], 0);
  assertStrictEquals(a1le[1], 0);
  assertStrictEquals(a1le[2], 1);
...
Deno.test("uint32sToBytes(*)", () => {
  assertStrictEquals(uint32sToBytes(Uint32Array.of()).length, 0);

  const a1be = uint32sToBytes(
  ...
  const a1x = uint32sToBytes(Uint32Array.of(0, 1, 0xFFFFFFFF));
  assertStrictEquals(a1x.length, 12);
  if (isBigEndian()) {
    assertStrictEquals(a1be[0], 0);
    assertStrictEquals(a1be[1], 0);
...
Deno.test("uint32sToBytes(*)", () => {
  ...
  assertStrictEquals(uint32sToBytes(g0).length, 0);
  ...
  const a1be = uint32sToBytes(g1, ByteOrder.BIG_ENDIAN);
  assertStrictEquals(a1be.length, 12);
  assertStrictEquals(a1be[0], 0);
  assertStrictEquals(a1be[1], 0);
  assertStrictEquals(a1be[2], 0);
  ...
  const a1le = uint32sToBytes(g2, ByteOrder.LITTLE_ENDIAN);
  assertStrictEquals(a1le.length, 12);
  assertStrictEquals(a1le[0], 0);
  assertStrictEquals(a1le[1], 0);
  assertStrictEquals(a1le[2], 0);
